...
 When you register for any statarea.com product we ask for information such as your name, email address.
 statarea.com uses collected information for the following general purposes: products and services provision, identification and authentication, services improvement, contact, and research.
 statarea.com does not share your personal information with third parties, unless explicitly approved by you.
Data storage
 statarea.com uses third party vendors and hosting partners to provide the necessary hardware, software, networking, storage, and related technology required to run our services. Although statarea.com owns the code, databases, and all rights to the statarea.com applications, you retain all rights to your data.
Disclosure
 statarea.com may disclose personally identifiable information under special circumstances, such as to comply with subpoenas or when your actions violate the Terms of Service of any of our applications.
Changes
 statarea.com may periodically update this policy. We will notify you about significant changes in the way we treat personal information by sending a notice to the primary email address specified in your statarea.com service primary account holder account or by placing a prominent notice on our site. You retain the right to access, amend, correct or delete your personal information where it is inaccurate at any time. To do so, please contact support@statarea.com
Privacy complaints by EU citizens
 In compliance with the Safe Harbor Principles, statarea.com commits to resolve complaints about your privacy and our collection or use of your personal information. European Union (EU) citizens with inquiries or complaints regarding this privacy policy should first contact statarea.com at support@statarea.com
Questions
 Any questions about this Privacy Policy should be addressed to support@statarea.com
...
References in this Privacy Policy to “bet365”, “we”, “us” or “our” relate to Hillside (Gibraltar Sports) LP, a Limited Partnership incorporated in Gibraltar (Registration number 198), and with its principal place of business at Unit 1.1, First Floor, Waterport Place, 2 Europort Avenue, Gibraltar for Sportsbook products and Hillside (Gibraltar Gaming) LP, a Limited Partnership incorporated in Gibraltar (Registration number 197), and with its registered office at Unit 1.1, First Floor, Waterport Place, 2 Europort Avenue, Gibraltar for Gaming products. We control the ways your Personal Data is collected and the purposes for which your Personal Data is used by bet365, acting as the “data controller” for the purposes of applicable European data protection legislation.
...
For more information on these rights you can contact data.protection@bet365.com.
